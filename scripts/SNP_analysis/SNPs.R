...
export.bed(ss_genomic, "../../DATA/SNP/human.bed")
...
save(ss_genomic, file = "../../DATA/SNP/human_genomic_granges.Rsave")
...
save(h_tx_ss, file = "../../DATA/SNP/human_table_bam.Rsave")
...
export.bed(ss_genomic, "../../DATA/SNP/human_CSS_SNP.bed")

random_genomic <- mapFromTranscripts(gr_random, cds)
random_genomic$seqnames <- as.character(seqnames(gr_random))
export.bed(random_genomic, "../../DATA/SNP/human_random_SNP.bed")
