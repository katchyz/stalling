# check riboseq before and after for H2
...
ht <- get(load(file = "/Volumes/USELESS/STALLING/SNP/human_table_bam.Rsave"))
h2 <- ht[ht$h2 == 1,]
...
load(file = "/Volumes/USELESS/STALLING/gr/human_stern_NODRUG.Rsave") # gr
...
save(dt_log2, file = "/Volumes/USELESS/STALLING/RQC/log2ratio_h2.Rsave")
...
save(dt_log2, file = "/Volumes/USELESS/STALLING/RQC/log2ratio_h2_whole.Rsave")
ggplot(dt_log2, aes(x = log2)) + geom_histogram() + theme_classic()
ggsave("/Volumes/USELESS/STALLING/RQC/log2ratio_h2_whole.png")

### H1
load(file = "/Volumes/USELESS/STALLING/gr/human_fibroblasts_stern2012.Rsave") # h1
gr <- split(gr, seqnames(gr))
h1 <- ht[ht$h1 == 1,]
...
save(dt_log2, file = "/Volumes/USELESS/STALLING/RQC/log2ratio_h1_whole.Rsave")
ggplot(dt_log2, aes(x = log2)) + geom_histogram() + theme_classic()
ggsave("/Volumes/USELESS/STALLING/RQC/log2ratio_h1_whole.png")


### H3
load(file = "/Volumes/USELESS/STALLING/gr/human_HeLa_stumpf2013.Rsave") # h3
gr <- split(gr, seqnames(gr))
h3 <- ht[ht$h3 == 1,]
...
save(dt_log2, file = "/Volumes/USELESS/STALLING/RQC/log2ratio_h3_whole.Rsave")
ggplot(dt_log2, aes(x = log2)) + geom_histogram() + theme_classic()
ggsave("/Volumes/USELESS/STALLING/RQC/log2ratio_h3_whole.png")



### H4
load(file = "/Volumes/USELESS/STALLING/gr/human_HEK_subtelny2014.Rsave") # h4
gr <- split(gr, seqnames(gr))
h4 <- ht[ht$h4 == 1,]
...
save(dt_log2, file = "/Volumes/USELESS/STALLING/RQC/log2ratio_h4_whole.Rsave")
ggplot(dt_log2, aes(x = log2)) + geom_histogram() + theme_classic()
ggsave("/Volumes/USELESS/STALLING/RQC/log2ratio_h4_whole.png")
...
h1 <- get(load(file = "/Volumes/USELESS/STALLING/RQC/log2ratio_h1_whole.Rsave"))
h2 <- get(load(file = "/Volumes/USELESS/STALLING/RQC/log2ratio_h2_whole.Rsave"))
h3 <- get(load(file = "/Volumes/USELESS/STALLING/RQC/log2ratio_h3_whole.Rsave"))
h4 <- get(load(file = "/Volumes/USELESS/STALLING/RQC/log2ratio_h4_whole.Rsave"))
