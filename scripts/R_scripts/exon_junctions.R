...
# export.bed(ss_genomic, "/Volumes/USELESS/STALLING/GO/GO_peaks_human.bed")
...
ggsave("/Volumes/USELESS/STALLING/PLOTS/exons/position_on_exons.png")
...
ggsave("/Volumes/USELESS/STALLING/PLOTS/exons/distance_to_junction_bin1.png")
...
####### get subsets #######
# load GO terms (BP)
go <- read.table("/Volumes/USELESS/STALLING/GO/GO_peaks_human_BP.txt", header = T)
...
ggsave("/Volumes/USELESS/STALLING/PLOTS/exons/distance_to_junction_SPLICING_GO_bin1.png")
...
########
load("/Volumes/USELESS/STALLING/PLOTS/exons/R_exon_junctions.RData")
...
ggplot(dt_ss, aes(x = position_on_exon)) + geom_histogram()
ggsave("/Volumes/USELESS/STALLING/PLOTS/exons/position_on_exons_NO1EX.png")

dt_junc <- data.table(type = c(rep("junction_before", nrow(dt_ss)), rep("junction_after", nrow(dt_ss))),
                      distance = c(dt_ss$junction_before, dt_ss$junction_after))

ggplot(dt_junc, aes(x = distance)) + geom_histogram(binwidth = 1) + xlim(-50,51)
ggsave("/Volumes/USELESS/STALLING/PLOTS/exons/distance_to_junction_bin1_NO1EX.png")
...
ggsave("/Volumes/USELESS/STALLING/PLOTS/exons/position_on_exons_start45.png")
# save(dt_ss, file = "/Volumes/USELESS/STALLING/PLOTS/exons/CSSs_position_on_exon.Rsave")
...
ggsave("/Volumes/USELESS/STALLING/PLOTS/exons/distance_to_junction_bin1_start45.png")
# change direction
dt_junc$distance <- -dt_junc$distance
ggplot(dt_junc, aes(x = distance)) + geom_histogram(binwidth = 1) + xlim(-50,51) + theme_classic()
ggsave("/Volumes/USELESS/STALLING/PLOTS/exons/distance_to_junction_bin1_start45_reversed.png")
