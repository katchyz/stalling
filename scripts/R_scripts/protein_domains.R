...
cath <- read.table("/Volumes/USELESS/STALLING/protein_domains/cath_human.tsv", header = T, sep = "\t")


ss_uniprot <- read.table("/Volumes/USELESS/STALLING/protein_domains/uniprot_gene.tab",
                         header = T, sep = "\t")
...
ggsave("/Volumes/USELESS/STALLING/PLOTS/exons/protein_boundaries.png")
...
###################
# save(min_dist_to_bound_end, file = "/Volumes/USELESS/STALLING/protein_domains/min_dist_to_bound_end.Rsave")
###################
