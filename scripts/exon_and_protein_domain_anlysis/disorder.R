...
load(file = "../../DATA/domains/CSSs_position_on_exon.Rsave") # dt_ss
...
# ggsave("hotoops_position_on_exon.png")
...
disorder_path <- "../../DATA/domains"
distx <- as.character(read.table("../../DATA/domains/tx.txt")$V1)
...
t.test(as.numeric(meta_coils[17,2:ncol(meta_coils)]), as.numeric(random_meta_coils[17,2:ncol(random_meta_coils)]))
